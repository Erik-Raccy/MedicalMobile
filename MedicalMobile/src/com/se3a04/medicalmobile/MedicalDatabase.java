...
public class MedicalDatabase {
	...
	//Database Name
	private static final String DATABASE_NAME = "Database5";
	...
	public boolean deleteUser(String byWhat, String what){
		return ourDatabase.delete(USER_TABLE, byWhat + "=?", new String[] {what}) > 0;
	}
